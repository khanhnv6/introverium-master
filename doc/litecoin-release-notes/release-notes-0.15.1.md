Introveriumcoin Core version *0.15.1* is now available from:

  <https://download.introveriumcoin.org/introveriumcoin-0.15.1/>
...
A number of changes to the way Introveriumcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 intrM per kB (0.00001 INTR). This is to prepare for dropping the minimum transaction fee to 0.1 intrM per kB (0.0001 INTR) in the next release.
