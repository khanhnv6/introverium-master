...
#if defined(NDEBUG)
# error "Introveriumcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Introveriumcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s INTR additional fees, %d delta bytes\n",
...
{
    if (nHeight == 1) return (14000000 * COIN);
...
void ThreadScriptCheck() {
    RenameThread("introveriumcoin-scriptch");
