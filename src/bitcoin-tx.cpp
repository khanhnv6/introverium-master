...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s introveriumcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  introveriumcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded introveriumcoin transaction") + "\n" +
              "  introveriumcoin-tx [options] -create [commands]   " + _("Create hex-encoded introveriumcoin transaction") + "\n" +
              "\n";
